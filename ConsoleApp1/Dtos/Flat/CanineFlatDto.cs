...
public sealed record CanineFlatDto
{
	...
	public required PartnerOneOf Partner { get; set; }
	public required PupsCollection Pups { get; set; }

	public sealed record PupsCollection
	{
		public IReadOnlyCollection<CanineFlatDto>? Canine { get; set; }
		public IReadOnlyCollection<GoldenFlatDto>? Golden { get; set; }
	}
